...
use ExpertsCrm\Transactions\NoteTransaction;
use ExpertsCrm\Validators\Note\NoteValidator;
...
class NoteAction {
    ...
    static function view(\WP_REST_Request $request) {
        ...
        try {
            ...
            $doc = NoteTransaction::view(new ViewConfig($id, $expanded));
    ...
    static function store(\WP_REST_Request $request) {
        ...
        try {
            ...
            $id = NoteTransaction::store($cleanDoc, $urlParams["id"] ?? null);
