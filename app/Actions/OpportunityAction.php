...
use ExpertsCrm\Transactions\OpportunityTransaction;
use ExpertsCrm\Validators\Opportunity\OpportunityValidator;
...
class OpportunityAction {
    ...
    static function list(\WP_REST_Request $request) {
        ...
        $result = OpportunityTransaction::list(
    ...
    static function trash(\WP_REST_Request $request) {
        ...
        $validator = OpportunityValidator::make();
        ...
        try {
            OpportunityTransaction::trash($id);
    ...
    static function view(\WP_REST_Request $request) {
        ...
        try {
            ...
            $doc = OpportunityTransaction::view(new ViewConfig($id, $expanded));
    ...
    static function store(\WP_REST_Request $request) {
        ...
        try {
            ...
            $id = OpportunityTransaction::store($cleanDoc, $urlParams["id"] ?? null);
