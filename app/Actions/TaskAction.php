...
use ExpertsCrm\Transactions\TaskTransaction;
use ExpertsCrm\Validators\Task\TaskValidator;
...
class TaskAction {
    ...
    static function view(\WP_REST_Request $request) {
        ...
        try {
            ...
            $doc = TaskTransaction::view(new ViewConfig($id, $expanded));
    ...
    static function store(\WP_REST_Request $request) {
        ...
        try {
            ...
            $id = TaskTransaction::store($cleanDoc, $urlParams["id"] ?? null);
